...
namespace cyclone {
    ...
    public:
	    ...
	    ParticleWind(const Vector3 &wind);

	    virtual void updateForce(Particle *particle, real duration);
	
	    void updateWindSpeed(Vector3 w);
    };
   ...
   /**
    * Applies an uplift - like a column of air
    *
    * Contains a radius around a center point and the direction the 'fluid' is moving
    */ 
    ...
    public:
	    ...
	    ParticleUplift(Vector3 &centerPoint, real radius, Vector3 &Updraft);
	    
	    void init(Vector3 center, real r, Vector3 ds);
	    virtual void updateForce(Particle *particle, real duration);
	
    };
    
    /**
     * Contains a radius around a center point.  The object should collide when it is within it's radius.
     *
     * The generator has a point mass and it's own gravity! :)
     */
	...
	public:
	    ...
	    ParticlePointGravity(Vector3 &centerPoint, real radius, real mass, real g);
